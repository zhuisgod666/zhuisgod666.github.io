...
const portfolio = {
  ...
  projects: [
    ...
    { category: "crawler", number: "07", title: "晨星云音乐", description: "爬虫采集到的音乐制作的仿网易云风格在线音乐播放器，支持歌单切换、播放控制、进度拖拽与歌词展示。", tags: ["JavaScript", "Audio API", "UI Design"], link: "Portfolio/晨星云音乐网站.html", accent: "blue", bgImage: "Portfolio/bgimgs/晨星云音乐.png" },
